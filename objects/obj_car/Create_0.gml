...
//rear wheel
wheel = instance_create_layer(x - rearLoc, y, layer, obj_tire);
...
//front wheel
wheel = instance_create_layer(x + frontLoc, y, layer, obj_tire);

wheel.image_xscale = image_xscale;
wheel.image_yscale = image_yscale;

//reuses fixture to attach to wheel
physics_fixture_bind_ext(fix, wheel, 
wheel.sprite_width / 2, wheel.sprite_width / 2);
//deletes fixture
